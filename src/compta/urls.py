...
urlpatterns = [
    ...
    path("evolution-bfr/", views.evolution_bfr_view, name="evolution-bfr"),
    path("evolution-ebe/", views.evolution_ebe_view, name="evolution-ebe"),
    path("evolution-leverage-brut/", views.evolution_leverage_brut_view, name="evolution-leverage-brut"),
    path("evolution-delais-clients/", views.evolution_delais_clients_view, name="evolution-delais-clients"),
    path("evolution-delais-fournisseurs/", views.evolution_delais_fournisseurs_view, name="evolution-delais-fournisseurs"),
